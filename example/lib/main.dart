...
import 'pages/flip_a_to_z_page.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                title: const Text('Flip A to Z'),
                subtitle: const Text('The alphabet!'),
                onTap: () => Navigator.of(context).pushNamed('flip_atoz'),
              ),
              ListTile(
